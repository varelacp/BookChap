...
// const RentBook = () => {
//   const { selectedRentalBooks } = useContext(CartContext);

//   const handleRentalSubmit = async () => {
//     const rentalDate = new Date();
//     const returnDate = new Date(rentalDate);
//     returnDate.setDate(returnDate.getDate() + 15); // Add 15 days to the rental date

//     console.log('Selected Rental Books:', selectedRentalBooks);
//     console.log('Rental Date:', rentalDate);
//     console.log('Return Date:', returnDate);

//     // Create a rental for each selected book
//     try {
//       for (const book of selectedRentalBooks) {
//         await rentBook(book._id, rentalDate, returnDate);
//       }

//       // Perform any necessary actions after successful rental creation
//     } catch (error) {
